...
******************************************************************************
 File: main.c 
 [ROBOT 1 | RX address: C2:C2:C2:C2:C2 (Pipe 1)]
 ------------
 This is the VoCoRoBo Robot Module 1. Please see documentation.
 ...
 Receives control bytes from Control Module to its Pipe 1 (C2:C2:C2:C2:C2) addr.
...
{ 
	...
	nrf_initialize(nrf_CONFIG_DFLT_VAL | nrf_CONFIG_PWR_UP | nrf_CONFIG_PRIM_RX, //1 byte CRC, powered up, RX
				...
				nrf_EN_RXADDR_ERX_P1, 			//enable receive on pipes 1		//SAGUN Sat, Jan 1, 2011 @ 10:30 AM
