...
//////////////////////////////////////////////////////////////////////////////////
#include "spi1.h"
#define spi_masterinit(void)		spi1_masterinit(void)//SAGUN
//#define spi_slaveinit(void)		spi1_slaveinit(void)//SAGUN
...
//////////////////////////////////////////////////////////////////////////////////
//#include <delay.h>
#include <delay.h>	//for delay_us and delay_ms	SAGUN
...
//
//	 #define nrf_CE_IOREGISTER		IOPORT1
//   #define nrf_CE_PINMASK		0x01
//
...
//
//	 #define nrf_CE_IOREGISTER		IOPORT1
//   #define nrf_CE_PINMASK		IOPORT1_PIN0
//
// You should also change the include file name below to whatever the name of your 
//   processor's register definition include file is.
/////////////////////////////////////////////////////////////////////////////////////
#include <mega32.h>		//SAGUN
...
#define nrf_CE_IOREGISTER		PORTB	//PORTC		//SAGUN
#define nrf_CE_PINMASK			0x04	//0b00000100 i.e. PORTB.PIN2 (3rd pin)		//0x02

//defines for uC pins CSN pin is connected to
//This is used so that the routines can send properly operate the SPI interface
// on the nrf24l01.
//Change these definitions (and then recompile) to suit your particular application.
#define nrf_CSN_IOREGISTER		PORTB	//PORTC		//SAGUN
#define nrf_CSN_PINMASK		0x10	//0b00001000 i.e. PORTB.PIN2 (5th pin = /SS)		//0x04

//defines for uC pins IRQ pin is connected to
//This is used so that the routines can poll for IRQ or create an ISR.
//Change these definitions (and then recompile) to suit your particular application.
#define nrf_IRQ_IOREGISTER		PORTB	//PORTB		//SAGUN
#define nrf_IRQ_PINMASK		0x08	//0b00001000 i.e. PORTB.PIN2 (4rd pin)		//0x01
...
//   number.
////////////////////////////////////////////////////////////////////////////////////
#define nrf_CONFIG_DFLT_VAL			0x08
#define nrf_EN_AA_DFLT_VAL			0x3F
#define nrf_EN_RXADDR_DFLT_VAL		0x03
#define nrf_SETUP_AW_DFLT_VAL		0x03
#define nrf_SETUP_RETR_DFLT_VAL		0x03
#define nrf_RF_CH_DFLT_VAL			0x05		//0x02
#define nrf_RF_SETUP_DFLT_VAL		0x0F
#define nrf_STATUS_DFLT_VAL			0x0E
#define nrf_OBSERVE_TX_DFLT_VAL		0x00
#define nrf_CD_DFLT_VAL				0x00
#define nrf_RX_ADDR_P0_B0_DFLT_VAL	0xE7
#define nrf_RX_ADDR_P0_B1_DFLT_VAL	0xE7
#define nrf_RX_ADDR_P0_B2_DFLT_VAL	0xE7
#define nrf_RX_ADDR_P0_B3_DFLT_VAL	0xE7
#define nrf_RX_ADDR_P0_B4_DFLT_VAL	0xE7
#define nrf_RX_ADDR_P1_B0_DFLT_VAL	0xC2
#define nrf_RX_ADDR_P1_B1_DFLT_VAL	0xC2
#define nrf_RX_ADDR_P1_B2_DFLT_VAL	0xC2
#define nrf_RX_ADDR_P1_B3_DFLT_VAL	0xC2
#define nrf_RX_ADDR_P1_B4_DFLT_VAL	0xC2
#define nrf_RX_ADDR_P2_DFLT_VAL		0xC3
#define nrf_RX_ADDR_P3_DFLT_VAL		0xC4
#define nrf_RX_ADDR_P4_DFLT_VAL		0xC5
#define nrf_RX_ADDR_P5_DFLT_VAL		0xC6
#define nrf_TX_ADDR_B0_DFLT_VAL		0xE7
#define nrf_TX_ADDR_B1_DFLT_VAL		0xE7
#define nrf_TX_ADDR_B2_DFLT_VAL		0xE7
#define nrf_TX_ADDR_B3_DFLT_VAL		0xE7
#define nrf_TX_ADDR_B4_DFLT_VAL		0xE7
#define nrf_RX_PW_P0_DFLT_VAL		0x00
#define nrf_RX_PW_P1_DFLT_VAL		0x00
#define nrf_RX_PW_P2_DFLT_VAL		0x00
#define nrf_RX_PW_P3_DFLT_VAL		0x00
#define nrf_RX_PW_P4_DFLT_VAL		0x00
#define nrf_RX_PW_P5_DFLT_VAL		0x00
#define nrf_FIFO_STATUS_DFLT_VAL	0x11
...
#define nrf_STATUS_RX_P_NO_RX_FIFO_NOMT			0x0E
...
void nrf_rx_standby_to_active(void);
void nrf_rx_active_to_standby(void);
...
unsigned char nrf_get_plos_cnt(void);
void nrf_clear_plos_cnt(void);
void nrf_clear_plos_cnt_param(unsigned char rf_ch);
unsigned char nrf_get_arc_cnt(void);

//utility functions
bool nrf_cd_active(void);
void nrf_clear_flush(void);
unsigned char nrf_get_rx_pipe(void);
...
bool nrf_irq_pin_active(void);
bool nrf_irq_rx_dr_active(void);
bool nrf_irq_tx_ds_active(void);
bool nrf_irq_max_rt_active(void);
void nrf_irq_clear_all(void);
void nrf_irq_clear_rx_dr(void);
void nrf_irq_clear_tx_ds(void);
void nrf_irq_clear_max_rt(void);

//FIFO_STATUS check functions
bool nrf_fifo_tx_reuse(void);
bool nrf_fifo_tx_full(void);
bool nrf_fifo_tx_empty(void);
bool nrf_fifo_rx_full(void);
bool nrf_fifo_rx_empty(void);

//IO interface-related functions
void nrf_transmit(void);
void nrf_clear_ce(void);
void nrf_set_ce(void);
void nrf_clear_csn(void);
void nrf_set_csn(void);
bool nrf_ce_pin_active(void);
bool nrf_csn_pin_active(void);
